...
CREATE TABLE ECFPS_ADR_PROXY_TBL (
	...
	IS_XB_OPT_OUT boolean DEFAULT false NOT NULL,
...
CREATE TABLE ECFPS_PAYMENT_TBL (
	...
	-- Reserved fields]
	DEBTOR_ACCT_ID varchar(200) NOT NULL, -- Increased for encryption
	...
	-- Reserved fields]
	CREDITOR_ACCT_ID varchar(200) NOT NULL, -- Increased for encryption
